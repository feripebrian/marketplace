<div class="page-header">
	<h3>TAMBAH DATA PERATURAN & INFORMASI</h3>
</div>
...
<div class="content-data">
	<ol class="breadcrumb">
		...
		<li class="active">Tambah Data Link Peraturan & Informasi</li>
	</ol>

	<form action="" class="form-horizontal form-input" id="form-link-surat" enctype="multipart/form-data">
		...
		<div class="form-group">
			<div class="col-sm-offset-2 col-sm-6">
				<button type="submit" class="btn btn-primary" name="simpan-link-surat" id="simpan-link-surat"><i class="fa fa-save"></i> Simpan</button>
			</div>
		</div>
	</form>
</div>
