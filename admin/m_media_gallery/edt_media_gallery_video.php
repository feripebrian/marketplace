	...
	if( empty($_GET['id']) ) {
		echo "
			<script>
				...
				window.location.href='http://localhost/kemenagjaksel/admin/?page=m_medgall_video';
			</script>
		";
	} else {
...
<div class="content-data">
	...
	<form action="" class="form-inline form-input" id="form-media-gallery-video">
		...
		<div class="input-group">
			<label class="input-group-btn">
				<span class="btn btn-danger" style="color:#f7f7f7;">
					Browse&hellip; <input type="file" id="media" name="media" style="display: none;" readonly>
				</span>
			</label>
			<input type="text" class="form-control" size="30" value="<?= $medgall_video['nama_file_medgall']; ?>" readonly>
		</div>
		...
		<div class="row" id="fetch-data-video">
			<div class="col-sm-8">
				<div class="input-group">
					<input type="text" class="form-control" name="judul" id="judul" size="100%" value="<?= $medgall_video['judul']; ?>" placeholder="Masukkan Judul Video" autofocus>';
					<br>
					<div class="pesan">
