<div class="page-header">
	<h3>TAMBAH DATA DAMPAK LAYANAN</h3> 
</div>

<div class="content-data">
	<ol class="breadcrumb">
		<li><a href="?page=home">Home</a></li>
		<li><a href="?page=m_dampak">DAMPAK</a></li>
		<li class="active">DAMPAK</li> 
	</ol>

	<form action="" class="form-horizontal form-input" id="form-zona">
		<div class="form-group">
			<label for="id_zona" class="col-sm-2 control-label"><span>**</span> ID dampak</label>
			<div class="col-sm-5">
				<input type="text" class="form-control" name="id_zona" id="id_zona" placeholder="Masukkan ID dampak" required autofocus>
			</div>
...
<script src="../assets/js/form_validation/form_validation_dampak.js"></script>