<div class="page-header">
	<h3>TAMBAH DATA LINK MASYARAKAT</h3>
</div>
...
<div class="content-data">
	<ol class="breadcrumb">
		...
		<li class="active">Tambah Data Link Masyarakat</li>
	</ol>

	<form action="" class="form-horizontal form-input" id="form-link-masyarakat" enctype="multipart/form-data">
		...
		<div class="form-group">
			<div class="col-sm-offset-2 col-sm-6">
				<button type="submit" class="btn btn-primary" name="simpan-link-masyarakat" id="simpan-link-masyarakat"><i class="fa fa-save"></i> Simpan</button>
			</div>
		</div>
	</form>
</div>
