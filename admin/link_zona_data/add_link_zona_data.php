...
<div class="content-data">
	<ol class="breadcrumb">
		...
		<li class="active">Tambah Data Link Zona</li>
	</ol>

	<form action="" class="form-horizontal form-input" id="form-link-zona" enctype="multipart/form-data">
		...
		<div class="form-group">
			<div class="col-sm-offset-2 col-sm-6">
				<button type="submit" class="btn btn-primary" name="simpan-link-zona" id="simpan-link-zona"><i class="fa fa-save"></i> Simpan</button>
			</div>
		</div>
	</form>
</div>
