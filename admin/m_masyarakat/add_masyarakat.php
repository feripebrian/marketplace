<div class="page-header">
	<h3>TAMBAH DATA INDEKS MASYARAKAT</h3> 
</div>

<div class="content-data">
	<ol class="breadcrumb">
		<li><a href="?page=home">Home</a></li>
		<li><a href="?page=m_masyarakat">Masyarakat</a></li>
		<li class="active">Masyarakat</li> 
	</ol>

	<form action="" class="form-horizontal form-input" id="form-zona">
		<div class="form-group">
			<label for="id_zona" class="col-sm-2 control-label"><span>**</span> ID Masyarakat</label>
			<div class="col-sm-5">
		...
		<div class="form-group">
			<label for="nama_zona" class="col-sm-2 control-label"><span>**</span> Nama Masyarakat</label>
			<div class="col-sm-5">
...
<script src="../assets/js/form_validation/form_validation_masyarakat.js"></script>