...
<div class="content-data">
	<ol class="breadcrumb">
		...
		<li class="active">Tambah Data Link Survey</li>
	</ol>

	<form action="" class="form-horizontal form-input" id="form-link-survey" enctype="multipart/form-data">
		...
		<div class="form-group">
			<div class="col-sm-offset-2 col-sm-6">
				<button type="submit" class="btn btn-primary" name="simpan-link-survey" id="simpan-link-survey"><i class="fa fa-save"></i> Simpan</button>
			</div>
		</div>
	</form>
</div>
