<div class="page-header">
	<h3>TAMBAH DATA PENGADUAN MASYARAKAT</h3> 
</div>

<div class="content-data">
	<ol class="breadcrumb">
		<li><a href="?page=home">Home</a></li>
		<li><a href="?page=m_pengaduan">PENGADUAN</a></li>
		<li class="active">PENGADUAN</li> 
	</ol>

	<form action="" class="form-horizontal form-input" id="form-zona">
		<div class="form-group">
			<label for="id_zona" class="col-sm-2 control-label"><span>**</span> ID pengaduan</label>
			<div class="col-sm-5">
		...
		<div class="form-group">
			<label for="nama_zona" class="col-sm-2 control-label"><span>**</span> Nama pengaduan</label>
			<div class="col-sm-5">
...
<script src="../assets/js/form_validation/form_validation_pengaduan.js"></script>